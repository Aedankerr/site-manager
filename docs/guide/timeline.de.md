...
Wenn sich zwei oder mehr Berufserfahrungen zeitlich um mindestens 1 Monat überlappen, werden sie im Zeitstrahl automatisch als **parallele Spuren** dargestellt:

- Die gleichzeitige Position wird auf eine **Nebenspur** aufgeteilt — eine erhöhte Linie oberhalb des Hauptzeitstrahls
...
Es ist keine Konfiguration erforderlich — die Verzweigung erfolgt vollautomatisch basierend auf Ihren Erfahrungsdaten. Kurze Überlappungen unter 1 Monat (üblich bei Stellenwechseln) werden absichtlich ignoriert.
