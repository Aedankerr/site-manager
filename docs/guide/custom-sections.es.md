...
| Diseño | Ideal para |
|--------|------------|
| **2-Column Grid** | Elementos emparejados como idiomas y nivel de competencia, herramientas y nivel de experiencia |
...
Para los diseños de cuadrícula, lista, tarjeta y viñetas, cada elemento tiene una casilla **"Hide title"**. Cuando está activada, el elemento se muestra sin su encabezado de título — útil cuando el contenido habla por sí mismo.

## Gestión de elementos de secciones personalizadas
