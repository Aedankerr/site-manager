...
Ce guide couvre tout ce que vous pouvez faire avec l'interface d'administration de CV Manager.
...
- **[Jeux de donnees](datasets.md)** — Enregistrer plusieurs versions de CV pour differents publics
...
Ouvrez les **Parametres** — la version actuelle (par ex. `v1.11.0`) est affichee dans le coin inferieur gauche du pied de page de la fenetre modale.
