...
- :material-rocket-launch: **[Getting Started](getting-started/index.md)** — Install and set up CV Manager
- :material-book-open-variant: **[User Guide](guide/index.md)** — Learn how to use every feature
- :material-cog: **[Advanced](advanced/index.md)** — SEO, security, and ATS settings
- :material-frequently-asked-questions: **[FAQ](reference/faq.md)** — Answers to common questions
